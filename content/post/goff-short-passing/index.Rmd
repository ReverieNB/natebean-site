...
I created to learn about some of my favorite topics using R and with the beginning of the beginning 2020 NFL season, my initial focus is on sports analytics. In particular, I want to focus on my favorite team, the LA Rams. I'm new to football analytics, so I'm looking forward to learning as I go and hopefully stumbling across some interesting insights along the way.
...
```{r, warning=FALSE}
#needs to be resized for the post
...
- Goff's effectiveness using play action and with pre-snap motion (data pending)
